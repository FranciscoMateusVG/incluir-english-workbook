...
// task transcript JSONL and write it to complementary-material/review-parts/rev-N.html (raw HTML).
const fs = require('fs');
...
const OUT_DIR = path.resolve(__dirname, '../../../content/b4/complementary-material/review-parts');
