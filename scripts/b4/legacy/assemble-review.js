...
const PARTS_DIR = path.resolve(__dirname, '../../../content/b4/complementary-material/review-parts');
const OUT = path.resolve(__dirname, '../../../content/b4/complementary-material/review-worksheet.html');
